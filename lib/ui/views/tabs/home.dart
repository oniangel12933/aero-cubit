...
class _HomeView extends StatelessWidget {
  ...
  void openCorePage({required BuildContext context, required String launchId, required String coreId}) {
    Navigator.pushNamed(
      context,
      CorePage.route,
      arguments: {
  ...
  String coreSubtitle({required BuildContext context, required Core core, required bool isSideCore}) =>
